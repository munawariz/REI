...
def postsave_tp(sender, instance, created, **kwargs):
    if created:
        semester1 = Semester.objects.create(tahun_pelajaran=instance, semester='Ganjil', is_active=False)
        semester2 = Semester.objects.create(tahun_pelajaran=instance, semester='Genap', is_active=False)
